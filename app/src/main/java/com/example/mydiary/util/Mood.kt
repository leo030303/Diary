...
enum class Mood(val icon: ImageVector, val selectedIcon: ImageVector, val color: Color, val title: String, val barPercentage: Int, val value: Int) {
    ...
    GOOD(Icons.Outlined.Face, Icons.Filled.Face, Color(red = 120, green = 190, blue = 50), "Good", 80, 3),
    AWESOME(Icons.Outlined.Face, Icons.Filled.Face, Color(red = 52, green = 178, blue = 150), "Awesome", 100, 4)
}
